...
15. Заменете съобщението, показано на играча за това какви са неговите цели (използвайте `<count>` или `%count%` за да вмъкнете напредъка на целта)

...
| # | Избор                                           | Описание                                                                                                            |
| - | ----------------------------------------------- | ------------------------------------------------------------------------------------------------------------------- |
| 1 | Дайте куест глобално при влизане                | Дали да се принуждават играчите да участват при влизане в системата                                                 |
| 2 | Разрешаване на подреждане с глобални мисии      | Дали играчите могат да участват, докато са ангажирани в други глобални куестове                                     |
| 3 | Информирайте играчите при стартиране на мисията | Дали играчите трябва да бъдат уведомявани за участие при влизане в системата                                        |
| 4 | Замени настройката за „максимални куестове“     | Дали тази задача може да игнорира настройката за [конфигурация](../setup/configuration.md) „max-quests“ за играчите |
